...
function largest_product(digits, amount) {

    let product = 0, out = 0,
    start = 0, end = amount,
    size = digits.length - amount,
    dig, dig_1;

    for (let i = 0; i < size; i++) {
        dig = digits.slice(start + i, end + i);
        dig_1 = dig[end - 1];
        if (dig_1 === 0) {
            i += amount - 1;
            continue;
...
let digits = [7, 3, 1, 6, 7, 1, 7, 6, 5, 3, 1, 3, 3, 0, 6, 2, 4, 9, 1, 9,
...
console.log(largest_product(digits, 13));