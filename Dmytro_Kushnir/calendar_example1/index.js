const calendar = document.querySelector(".calendar"); //selecting block for calendar :
// TODO make calendars for all mounthes or even years
const days = calendar.querySelectorAll(".calendar__day"); // selecting all days
