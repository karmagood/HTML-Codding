...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_handlebars__ = __webpack_require__(8);
...
const submitHandler = (event) => {
    ...
    Promise.all([
        ...
        fetch(templateSrc)
            ...
            .then((text) => {
                return __WEBPACK_IMPORTED_MODULE_0_handlebars___default.a.compile(text);
            })
    ])
        .then((result) => {
            const data = result[0];
